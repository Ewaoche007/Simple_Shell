...
/**
 * find_builtin - meant to finds a builtin command
 * @info: its parameter & return info struct
 *
...
/**
 * fork_cmd - forks for an exec thread to run cmd
